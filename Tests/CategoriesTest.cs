...
namespace ToDoList
{
  public class CategoryTest : IDisposable
  {
    ...
    public void Test_GetTasks_RetrievesAllTasksWithCategory()
    {
      ...
      Task firstTask = new Task("Mow the lawn", "2017-02-17", testCategory.GetId());
      firstTask.Save();
      Task secondTask = new Task("Do the dishes", "2017-02-17", testCategory.GetId());
      secondTask.Save();
    ...
    public void Test_Delete_DeletesCategoryFromDatabase()
    {
      ...
      Task testTask1 = new Task("Mow the lawn", "2017-02-17", testCategory1.GetId());
      testTask1.Save();
      Task testTask2 = new Task("Send emails", "2017-02-17", testCategory2.GetId());
      testTask2.Save();
