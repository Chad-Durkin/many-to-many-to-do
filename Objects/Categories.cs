...
namespace ToDoList
{
    public class Category
    {
        ...
        // //Delete Specific Category and Tasks that are in that category
        // public void Delete()
        // {
        //   SqlConnection conn = DB.Connection();
        //   conn.Open();
        ...
        //   //DELETE FROM tasks WHERE category_id = @CategoryId;", conn)
        //
        //   SqlParameter categoryIdParameter = new SqlParameter();
        //   categoryIdParameter.ParameterName = "@CategoryId";
        //   categoryIdParameter.Value = this.GetId();
        ...
        public List<Task> GetTasks()
        {
            ...
            foreach(int taskId in taskIds)
            {
                ...
                taskQuery.Parameters.Add(new SqlParameter("@TaskId", taskId));
                ...
                while(queryReader.Read())
                {
                    ...
                    string taskDueDate = queryReader.GetDateTime(2).ToString("yyyy-MM-dd");
                    int taskDone = queryReader.GetByte(3);
